...
const ScrollStack: React.FC<ScrollStackProps> = ({
    ...
    const getElementOffset = useCallback(
        (element: HTMLElement) => {
            ...
            // Calculate absolute top safely bypassing css transforms
            while (el) {
                top += el.offsetTop;
        ...
        cardsRef.current.forEach((card, i) => {
            ...
            if (blurAmount) {
                ...
                for (let j = 0; j < cardsRef.current.length; j++) {
                    const jWrapper = cardsRef.current[j].parentElement as HTMLElement;
    ...
    useLayoutEffect(() => {
        ...
        // ALways scope strictly to the current component!
