...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }: BandProps) {
    ...
    const segmentLength = isMobile ? 2.4 : 2.2;
...
// Add wrapping container back in the main export instead of inside Canvas if we want DOM overlay:
// Wait, the outer component has the Canvas. I better just alter the main export function carefully!
